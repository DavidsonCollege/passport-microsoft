 ...
 */
 ...
 function MicrosoftStrategy(options, verify) {
     options = options || {}
     options.authorizationURL = options.authorizationURL || `https://login.microsoftonline.com/${options.tenant ? options.tenant : 'common'}/oauth2/v2.0/authorize`;
     options.tokenURL = options.tokenURL || `https://login.microsoftonline.com/${options.tenant ? options.tenant : 'common'}/oauth2/v2.0/token`;
